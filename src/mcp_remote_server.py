...
class OAuthProvider:
    ...
    def _validate_client(
        ...
        *,
        ...
        auth_method = (client.get("token_endpoint_auth_method") or "client_secret_basic").lower()
        requires_secret = auth_method != "none"

        if require_secret and requires_secret:
        ...
        elif client_secret and client_secret != client.get("client_secret"):
            # Public clients should not authenticate with a mismatching secret.
            raise web.HTTPUnauthorized(text="Invalid client secret")
    ...
    def issue_authorization_code(
        ...
        client = self._validate_client(client_id, None, require_secret=False)
