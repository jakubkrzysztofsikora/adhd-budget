---
description: Create implementation plans with thorough research (generic version)
model: opus
---
...
Please provide:
1. Task description or reference to requirements
2. Any relevant context, constraints, or specific requirements
3. Links to related documentation or existing code to reference
...
1. **Write the plan** to project documentation location:
   - **Preferred location**: `docs/plans/IMPL-[description].md`
   - Format: kebab-case description of the feature/task
...
1. **Present the plan location**:
   ...
   `docs/plans/IMPL-[description].md`
